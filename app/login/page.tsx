      ...
      <div className="relative z-10">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold py-3.5 rounded-xl transition-all shadow-[0_0_20px_rgba(245,158,11,0.15)] flex items-center justify-center mt-4"
          >
          ...
          <div className="text-center mt-6 text-sm text-slate-400">
            New to tracker?{' '}
            <Link href={`/register?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="text-amber-500 font-bold hover:underline">
              Create an account
            </Link>
          </div>
        </form>
